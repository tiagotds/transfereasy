...
public abstract class BaseEntity<T extends Serializable> {
	...
	/*
	 * As a starting point, we provide a basic mean for entities to test for
	 * equality using their "id".
	 * 
	 * Please note that THIS IS NOT ALWAYS ACCEPTABLE since newly generated ids
	 * might break Set/Collection semantics. Please refer to the documentarion
